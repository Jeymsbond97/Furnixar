            ...
            {blogData.slice(0,4).map((item,index)=>{
                return(
                    <div className="group" key={index}>
                        <Link to="/shop-v1" className="overflow-hidden block">
                        ...
                        <div className="text-center mt-4 px-3">
                            <ul className="flex items-center justify-center gap-[10px] flex-wrap">
                                ...
                                <li><Link to="/" className="inline-block text-title dark:text-white font-medium text-[15px] leading-none py-2 px-[10px] rounded-md bg-primary-midum dark:bg-primary">{item.tag}</Link></li>
                            </ul>
